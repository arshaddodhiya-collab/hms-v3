...
export const MOCK_USERS: MockUser[] = [
  {
    ...
    permissions: [
      ...
      PERMISSIONS.CMP_PATIENT_LIST,
      PERMISSIONS.CMP_PATIENT_VIEW,
      PERMISSIONS.CMP_PATIENT_EDIT,
      PERMISSIONS.CMP_APPOINTMENT_LIST,
      PERMISSIONS.CMP_APPOINTMENT_CREATE,
      PERMISSIONS.CMP_APPOINTMENT_VIEW,
      PERMISSIONS.CMP_APPOINTMENT_EDIT,
    ],
  },
  {
    username: 'doctor',
