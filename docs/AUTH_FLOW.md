...
The application uses a **Permission-Based** security model (not just Role-Based). This means access is granted based on specific _capabilities_ (e.g., `CMP_VITALS_WRITE`) rather than just the user's role name.
